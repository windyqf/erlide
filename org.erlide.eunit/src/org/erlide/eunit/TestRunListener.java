 ...
 * {@link JUnitCore#addTestRunListener(TestRunListener)} or as a contribution to
 * the <code>org.eclipse.jdt.junit.testRunListeners</code> extension point. The
...
public abstract class TestRunListener {
	 ...
	 * the session element after {@link #sessionFinished(ITestRunSession)} has
	 * finished.
	 * </p>
	 * 
	 * @param session
